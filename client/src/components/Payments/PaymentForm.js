...
function PaymentForm(props) {
    ...
    const [paymentTo, setPaymentTo] = useState(props.paymentTo)
    ...
    return (
        ...
        <Formik
            enableReinitialize 
            initialValues={{ 
                paymentTo: props.paymentTo ? props.paymentTo._id : '',
        ...
        (formikProps) => {
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <div className="formSubGroup">
                    ...
                    disableClearable
                    value={paymentTo}
                    onChange={(e, newValue) => setPaymentTo(newValue)
                    }
                    renderInput={params => 
                        <TextField {...params} 
                            label="paymentTo" 
